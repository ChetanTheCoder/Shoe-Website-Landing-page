...
document.getElementById("customLink").onclick = function () {
  window.open("https://www.linkedin.com/in/chetan-majumdar/", "_blank");
};
document.getElementById("customLink2").onclick = function () {
  window.open("https://github.com/Chetan-devloper", "_blank");
};

document.getElementById("customLink1").onclick = function () {
  window.open(" https://x.com/MajumdarCh74807/", "_blank");
};
